  ...
  return <div className='bg-white relative'>
    <div className='container mx-auto px-10 md:px-0'>
      ...
      <div className='flex items-center gap-3 mt-4'>
        <div className='text-[10px] font-semibold text-white bg-black ox-3 py-1 rounded-full'>
    ...
    <div className='w-[40vw] md:w-30[vw] h-[200px] flex items-center justify-center bg-white overglow-hidden absolute top-0 right-0'>
